if(APPLE)
  ...
  set_xcode_property(${APP_NAME} PRODUCT_BUNDLE_IDENTIFIER "com.fight.axmol")
...
if (_AX_TESTS)
  if(MACOSX)
    ...
    set_xcode_property(${TEST_TARGET_NAME} PRODUCT_BUNDLE_IDENTIFIER "com.fight.axmol-test")
